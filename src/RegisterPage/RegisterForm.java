...
public class RegisterForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jCombo1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "female", "male" }));
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(ln, javax.swing.GroupLayout.DEFAULT_SIZE, 224, Short.MAX_VALUE)
                                    .addComponent(un, javax.swing.GroupLayout.DEFAULT_SIZE, 224, Short.MAX_VALUE)
                                    .addComponent(pas)
                                    .addComponent(cpas)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jCombo1, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel8))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 124, 559, 450));
    ...
    if(fn.getText().isEmpty()&&ln.getText().isEmpty()&&un.getText().isEmpty()&&pas.getText().isEmpty()&&cpas.getText().isEmpty()){
      ...
      dbConnector dbc = new dbConnector();
        ...
        dbc.insertData("INSERT INTO tbl_register(r_fname, r_lname,r_username,r_password,r_confirmpass,r_accounttype,r_Gender)"+
                "VALUES("+fn.getText()+","+ln.getText()+","+un.getText()+","+pas.getText()+","+cpas.getText()+","+jCombo.getSelectedItem()+","+jCombo1.getSelectedItem()+","
                        + "'Pending')");
