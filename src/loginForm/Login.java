...
public class Login extends javax.swing.JFrame {
    ...
    public static boolean loginAcc(String username, String password,String confirmpassword,String email){
      ...
      try{
            String query = "SELECTED *FROM tbl_user WHEER u_username = " +username + "AND u_password = "+ password +"AND u_confirmpass = "+confirmpassword+""
                    + "AND u_email ="+ email+"";
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 97, 544, 370));
